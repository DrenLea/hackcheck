...
const TOPIC_DATA = {
  ...
  conceptMap: {
    ...
    // === 扩展：AI/ML 技术概念 ===
    '机器学习': ['machine learning','ML','model training','classifier'],
    '深度学习': ['deep learning','neural network','ML','deep model'],
    '大模型': ['LLM','large language model','GPT','foundation model'],
    '计算机视觉': ['computer vision','CV','image processing','vision'],
    '图像识别': ['image recognition','image classification','vision'],
    '目标检测': ['object detection','YOLO','detection','vision'],
    '人脸识别': ['face recognition','facial recognition','biometric'],
    'OCR': ['OCR','text recognition','optical character recognition'],
    '知识图谱': ['knowledge graph','graph database','ontology'],
    'RAG': ['RAG','retrieval augmented generation','knowledge base retrieval'],
    'Agent': ['agent','autonomous agent','AI agent','agentic'],
    '智能体': ['agent','autonomous','AI agent','agentic'],
    '多模态': ['multimodal','multi-modal','multimodal AI'],
    '生成式': ['generative','generative AI','AIGC','content generation'],
    '大语言模型': ['LLM','large language model','GPT','language model'],
    '向量数据库': ['vector database','embedding','vector search'],
    '微调': ['fine-tuning','fine-tune','model adaptation','LoRA'],
    '提示词': ['prompt','prompt engineering','prompt template'],
    '嵌入': ['embedding','vector','representation','encode'],

    // === 扩展：交互/UI 技术 ===
    '手势识别': ['gesture recognition','gesture','hand tracking'],
    '表情识别': ['facial expression','emotion detection','face expression'],
    '情感计算': ['affective computing','emotion AI','sentiment analysis'],
    '脑机接口': ['brain-computer interface','BCI','neural interface'],
    '语音助手': ['voice assistant','virtual assistant','Alexa','Siri'],
    '对话': ['dialogue','conversation','conversational'],
    '聊天': ['chat','chatbot','messaging'],
    '低代码': ['low code','low-code','no code','no-code'],
    '数字孪生': ['digital twin','simulation','virtual model'],
    '元宇宙': ['metaverse','virtual world','XR','3D virtual'],
    'Web3': ['web3','decentralized web','blockchain web'],
    'NFT': ['NFT','token','digital asset','mint'],
    '智能合约': ['smart contract','solidity','ethereum contract'],
    '去中心化': ['decentralized','decentralization','web3','P2P'],
    '大数据': ['big data','data pipeline','data engineering','data lake'],
    '数据挖掘': ['data mining','pattern mining','data analysis'],
    '微服务': ['microservice','microservices','service mesh'],
    '容器': ['container','docker','kubernetes','k8s'],
    '自动化': ['automation','automated','RPA','workflow automation'],

    // === 扩展：领域/行业 ===
    '法律': ['legal','law','attorney','compliance','legaltech'],
    '保险': ['insurance','claim','underwriting','insurtech'],
    '税务': ['tax','accounting','fiscal','tax filing'],
    '能源': ['energy','power','renewable','solar','grid'],
    '制造': ['manufacturing','factory','industry 4.0','industrial','smart manufacturing'],
    '零售': ['retail','store','POS','inventory','brick and mortar'],
    '影视': ['film','movie','streaming','video production','cinema'],
    '艺术': ['art','creative','artistic','digital art'],
    '设计': ['design','UI','UX','creative design','graphic design'],
    '建筑': ['architecture','building','construction','BIM','CAD'],
    '出版': ['publishing','content','editorial','press'],
    '体育': ['sports','athletics','fitness tracking','sports analytics'],
    '音乐制作': ['music production','audio synthesis','DAW','beat making'],
    '游戏开发': ['game development','game engine','Unity','game design'],
    '科学': ['science','research','scientific','experiment'],
    '科研': ['research','academic','scientific research','publication'],
    '天文': ['astronomy','space','celestial','telescope'],
    '生物': ['biology','biotech','genomic','bioinformatics'],
    '化学': ['chemistry','molecular','chemical','chemoinformatics'],
    '地理': ['geography','GIS','spatial','geolocation','mapping'],

    // === 扩展：人群/职业 ===
    '孕妇': ['pregnancy','pregnant','maternal','prenatal'],
    '婴儿': ['baby','infant','newborn','toddler'],
    '母婴': ['maternal','baby','parenting','childcare'],
    '青少年': ['teenager','youth','adolescent','teen'],
    '大学生': ['college student','university','campus','undergraduate'],
    '教师': ['teacher','education','instructor','tutor','educator'],
    '医生': ['doctor','physician','medical','diagnosis','clinical'],
    '护士': ['nurse','healthcare','patient care','nursing'],
    '农民': ['farmer','agriculture','grower','farming'],
    '司机': ['driver','driving','transportation','autonomous driving'],
    '外卖': ['food delivery','takeout','delivery rider'],
    '快递': ['express delivery','parcel','courier','logistics'],
    '留学生': ['international student','study abroad','overseas student'],
    '职场': ['workplace','career','professional','office'],
    '远程办公': ['remote work','telecommute','distributed team','WFH'],
    '自由职业': ['freelance','freelancer','gig','self-employed'],
    '创业者': ['entrepreneur','startup','founder','venture'],

    // === 扩展：活动/场景 ===
    '考试': ['exam','test','assessment','certification'],
    '考研': ['graduate exam','postgraduate','entrance exam','GRE'],
    '留学': ['study abroad','international student','overseas education'],
    '编程': ['programming','coding','development','developer'],
    '代码': ['code','coding','programming','source code','repository'],
    '面试': ['interview','job interview','hiring','mock interview'],
    '打卡': ['check-in','attendance','punch card','streak'],
    '签到': ['check-in','sign-in','attendance','roll call'],
    '报销': ['reimbursement','expense claim','expense report'],
    '审批': ['approval','workflow','sign-off','review'],
    '考勤': ['attendance','time tracking','workforce management'],
    '选课': ['course selection','enrollment','class registration'],
    '抢票': ['ticket booking','ticket grabbing','reservation'],
    '投票': ['voting','poll','election','ballot'],
    '拍卖': ['auction','bidding','bid','marketplace'],
    '租赁': ['rental','lease','rent','lending'],

    // === 扩展：社会公益 ===
    '公益': ['charity','nonprofit','social good','NGO'],
    '志愿': ['volunteer','volunteering','community service'],
    '扶贫': ['poverty alleviation','poverty','low-income','underserved'],
    '社区': ['community','neighborhood','local','residential'],
    '慈善': ['charity','donation','philanthropy','fundraising'],
    '文化遗产': ['cultural heritage','heritage','legacy','tradition'],
    '非遗': ['intangible heritage','traditional craft','folk art'],
    '方言': ['dialect','regional language','linguistics','local language'],
    '古籍': ['ancient text','manuscript','classical literature'],
    '博物馆': ['museum','exhibition','gallery','curation'],
    '罕见病': ['rare disease','orphan disease','rare disorder'],
    '多动症': ['ADHD','attention deficit','hyperactivity','focus disorder'],

    // === 扩展：供应链/物流 ===
    '溯源': ['traceability','provenance','tracking','origin tracking'],
    '供应链': ['supply chain','procurement','sourcing','chain'],
    '仓储': ['warehouse','inventory','storage','fulfillment'],
    '冷链': ['cold chain','refrigerated transport','temperature controlled'],

    // === 扩展：功能/能力 ===
    '匹配': ['matching','match','pairing','compatibility'],
    '调度': ['scheduling','dispatch','routing','allocation'],
    '规划': ['planning','route planning','optimization','strategy'],
    '优化': ['optimization','optimize','efficiency','performance tuning'],
    '生成': ['generation','generate','synthesis','content creation'],
    '检测': ['detection','detect','inspection','screening'],
    '识别': ['recognition','identify','classification','detection'],
    '分类': ['classification','categorize','label','taxonomy'],
    '聚类': ['clustering','cluster','grouping','segmentation'],
    '标注': ['annotation','labeling','tagging','markup'],
    '预测': ['prediction','forecast','predictive','forecasting'],
    '预警': ['early warning','alert','prediction','alarm'],
    '推荐系统': ['recommendation system','recommender','collaborative filtering'],
    '知识库': ['knowledge base','knowledge management','wiki','documentation'],
    '搜索引擎': ['search engine','search','query','indexing'],
    '聊天机器人': ['chatbot','chat bot','conversational AI','virtual assistant'],

    // === 扩展：安全/认证 ===
    '认证': ['authentication','auth','login','identity verification'],
    '授权': ['authorization','authz','permission','access control'],
    '防伪': ['anti-counterfeit','authentication','verification','genuine'],
    '反欺诈': ['fraud detection','anti-fraud','scam prevention'],
    '加密': ['encryption','crypto','cryptography','cipher'],
    '区块链溯源': ['blockchain traceability','provenance','immutable record'],

    // === 扩展：数据/分析 ===
    '数据清洗': ['data cleaning','data cleansing','ETL','data preprocessing'],
    '数据分析': ['data analysis','analytics','data insight','business intelligence'],
    '可视化': ['visualization','data visualization','chart','visual analytics'],
    '仪表盘': ['dashboard','analytics panel','metrics board'],
    '报表': ['report','reporting','statement','summary'],
    '指标': ['metric','KPI','indicator','measure'],
    '实时监控': ['real-time monitoring','live monitoring','surveillance'],

    // === 扩展：技术栈 ===
    'React': ['React','React.js','ReactJS','frontend framework'],
    'Vue': ['Vue','Vue.js','VueJS','frontend framework'],
    'Python': ['Python','Django','Flask','FastAPI'],
    'Flutter': ['Flutter','Dart','cross-platform mobile'],
    'TypeScript': ['TypeScript','TS','typed JavaScript'],
    'TensorFlow': ['TensorFlow','TF','ML framework'],
    'PyTorch': ['PyTorch','ML framework','deep learning'],
    'Node': ['Node.js','NodeJS','server-side JavaScript'],
    'Rust': ['Rust','systems programming','memory safe'],
    'Go': ['Go','Golang','backend','concurrent'],
    'React Native': ['React Native','mobile','cross-platform'],
    'Electron': ['Electron','desktop app','cross-platform desktop'],

    // === 扩展：更多概念 ===
    '虚拟现实': ['virtual reality','VR','immersive','3D environment'],
    '增强现实': ['augmented reality','AR','overlay','mixed reality'],
    '语音合成': ['text to speech','TTS','speech synthesis','voice generation'],
    '语音转文字': ['speech to text','STT','ASR','transcription'],
    '文字转语音': ['text to speech','TTS','speech synthesis'],
    '机器翻译': ['machine translation','MT','neural translation'],
    '情感分析': ['sentiment analysis','emotion analysis','opinion mining'],
    '命名实体': ['named entity recognition','NER','entity extraction'],
    '文本分类': ['text classification','document classification','NLP'],
    '图像生成': ['image generation','AI art','diffusion','GAN'],
    '视频生成': ['video generation','AI video','synthetic video'],
    '代码生成': ['code generation','AI coding','code assistant','Copilot'],
    '自动补全': ['autocomplete','auto-completion','intelligent completion'],
    '低功耗': ['low power','energy efficient','battery saving','edge computing'],
    '边缘计算': ['edge computing','edge AI','on-device','local inference'],
    '联邦学习': ['federated learning','privacy preserving ML','distributed training'],
    '差分隐私': ['differential privacy','privacy preserving','noise injection'],
  },
