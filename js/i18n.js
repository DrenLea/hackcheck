...
const I18N = {
  ...
  'sub.tech.aiadvice': { zh: 'AI选型顾问', en: 'AI Advisor' },
  ...
  // AI 选型顾问（承接阶段1选题结论）
  'tech.ai.title': { zh: '🤖 AI 选型顾问', en: '🤖 AI Stack Advisor' },
  'tech.ai.run': { zh: '根据选题结论推荐技术栈', en: 'Recommend stack from topic analysis' },
  'tech.ai.loading': { zh: 'AI 正在结合选题结论与团队约束生成选型建议…', en: 'Generating stack advice from your topic analysis…' },
  'tech.ai.done': { zh: 'AI 选型建议已生成', en: 'Stack advice generated' },
  'tech.ai.failed': { zh: 'AI 选型建议生成失败，可稍后重试；本地评估不受影响', en: 'Stack advice failed; local evaluation is unaffected' },
  'tech.ai.noContext': { zh: '请先在「选题评审」完成一次分析，AI 才能据此推荐技术栈。', en: 'Run a Topic Review analysis first so the AI has context.' },
  'tech.ai.stale': { zh: '⚠️ 团队配置已改动，建议重新生成', en: '⚠️ Team config changed — regenerate for updated advice' },
  'tech.ai.ctxTitle': { zh: '来自选题评审的结论', en: 'From your topic analysis' },
  'tech.ai.ctxSummary': { zh: '项目：', en: 'Project: ' },
  'tech.ai.ctxUser': { zh: '目标用户：', en: 'Target user: ' },
  'tech.ai.ctxFeatures': { zh: '核心功能：', en: 'Core features: ' },
  'tech.ai.ctxGaps': { zh: '差异点：', en: 'Differentiators: ' },
  'tech.ai.planPick': { zh: '推荐方案', en: 'Recommended plan' },
  'tech.ai.applyPlan': { zh: '应用该方案', en: 'Apply this plan' },
  'tech.ai.applyStack': { zh: '一键应用推荐技术', en: 'Apply recommended stack' },
  'tech.ai.applied': { zh: '已应用 AI 推荐选型，共 {n} 项技术', en: 'Applied AI stack — {n} technologies' },
  'tech.ai.applyEmpty': { zh: '推荐技术不在候选清单中，无法一键应用', en: 'Recommended items are not in the option list' },
  'tech.ai.recTitle': { zh: '✅ 推荐技术与理由', en: '✅ Recommended Stack' },
  'tech.ai.colTech': { zh: '技术', en: 'Technology' },
  'tech.ai.colRole': { zh: '承担角色', en: 'Role' },
  'tech.ai.colWhy': { zh: '为什么适合本项目', en: 'Why it fits' },
  'tech.ai.reuseTitle': { zh: '🧩 直接复用（勿自研）', en: '🧩 Reuse, Don\'t Build' },
  'tech.ai.avoidTitle': { zh: '🚫 不建议使用', en: '🚫 Avoid' },
  'tech.ai.mvpTitle': { zh: '🚀 MVP 开发顺序', en: '🚀 MVP Build Order' },
  'tech.ai.risksTitle': { zh: '⚠️ 落地风险', en: '⚠️ Delivery Risks' },
